...
from utils.io import (character_trait_vector, extract_characters,
                      extract_factions, extract_traits, load_jsonld)
    ...
    def build(self) -> nx.Graph:
        ...
        for character in characters:
            ...
            self.graph.add_node(
                ...
                type="Character",
                name=char_name,
                trait_vector=character_trait_vector(
                    character, TRAIT_ORDER, self.trait_prefix
                ),
            )
